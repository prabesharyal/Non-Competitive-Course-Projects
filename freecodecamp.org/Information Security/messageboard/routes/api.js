...
const threadSchema = new Schema({
  ...
  reported: { type: Boolean, default: false },
  replies: [replySchema], // Use the replySchema as the subdocument array
});
...
app.post('/api/replies/:board', async (req, res) => {
  try {
    ...
    // Update the bumped_on date to the latest reply's created_on date
...
app.get('/api/replies/:board', async (req, res) => {
  ...
  app.delete('/api/replies/:board', async (req, res) => {
    try {
      ...
      // Use the 'id' method on the mongoose array to find a reply by its '_id'
